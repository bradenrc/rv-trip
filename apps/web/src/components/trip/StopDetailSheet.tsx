              ...
              <div className="mb-3 flex flex-col gap-2.5 rounded-rv-card border border-rv-border bg-rv-surface p-4">
                ...
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    disabled={!canSave}
                    className="inline-flex cursor-pointer items-center gap-1.5 self-start rounded-rv-md border-none bg-rv-ember px-4 py-2 text-[13px] font-semibold text-rv-navy disabled:cursor-default disabled:opacity-45"
                  >
                    ...
                    {leaves.promotingId === it.id && (
                      <div className="flex flex-wrap items-end gap-2.5 rounded-rv-md border border-rv-border bg-rv-surface px-3 py-2.5">
                        ...
                        <button
                          ...
                          className="inline-flex cursor-pointer items-center gap-1.5 rounded-rv-md border-none bg-rv-ember px-4 py-2 text-[13px] font-semibold text-rv-navy"
                        >
